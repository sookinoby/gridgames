  ...
  .directive('timer', ['$compile', function ($compile) {
    return  {
      ...
      controller: ['$scope', '$element', '$attrs', '$timeout', function ($scope, $element, $attrs, $timeout) {
       ...
       $scope.$on('timer-start', function (event,name) {  
...
// console.log(event);
        ...
        $scope.$on('timer-reset-new', function (event,name,countdown) {
       // console.log(name );
       // console.log("Reset" + $scope.name);
        if($scope.name == name)
          {
      ...
      //   console.log("inside");
        ...
        $scope.stop = $scope.pause = $element[0].stop = $element[0].pause = function () {
          ...
          $scope.clear();
          $scope.$emit('timer-stopped', {timeoutId: timeoutId, millis: $scope.millis, seconds: $scope.seconds, minutes: $scope.minutes, hours: $scope.hours, days: $scope.days,name:$scope.name});
        };
